...
#if defined(DEBUG) || defined(TEST_BUILD)
...
#elif defined(PROD_U2F_NANOX_PRIVATE_KEY) && defined(PROD_FIDO2_NANOX_PRIVATE_KEY)
...
#else
#error Production attestation keys must be provisioned for non-debug builds
#endif
#endif
...
#elif defined(PROD_U2F_NANOSP_PRIVATE_KEY) && defined(PROD_FIDO2_NANOSP_PRIVATE_KEY)
...
#elif defined(PROD_U2F_STAX_PRIVATE_KEY) && defined(PROD_FIDO2_STAX_PRIVATE_KEY)
...
#elif defined(PROD_U2F_FLEX_PRIVATE_KEY) && defined(PROD_FIDO2_FLEX_PRIVATE_KEY)
...
#elif defined(PROD_U2F_APEX_P_PRIVATE_KEY) && defined(PROD_FIDO2_APEX_P_PRIVATE_KEY)
