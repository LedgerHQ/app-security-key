...
#warning Using prod keys for build TARGET_NANOS
...
#else
#warning Using test keys for build TARGET_NANOS
...
#warning Using prod keys for build TARGET_NANOX
...
#else
#warning Using test keys for build TARGET_NANOX
...
#warning Using prod keys for build TARGET_NANOS2
...
#else
#warning Using test keys for build TARGET_NANOS2
